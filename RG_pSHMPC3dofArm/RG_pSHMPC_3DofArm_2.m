...
% N = 150; % prediction horizon (number of steps)
% 
% 
...
% %Position:
% Q(1,1) = 1e8; Q(2,2) = 1e8; Q(3,3) = 1e8; Q(4,4) = 1e8;
% Q(5,5) = 1e8; Q(6,6) = 1e8;
% %Velocity:
% Q(7,7) = 1e2; Q(8,8) = 1e2; Q(9,9) = 1e2; Q(10,10) = 1e2;
% Q(11,11) = 1e2; Q(12,12) = 1e2;
% 
